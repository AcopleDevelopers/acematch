...
export default class Fetch extends React.Component {
  ...
  async reload() {
    ...
    return this.refs.child.refs.child.queryObservable.valueHasMutated()
  }
  ...
  getVariables(props) {
    ...
    params.forEach(variable => {
      variables[variable] =
        this.state.variables[variable] || varsInProps[variable]
    })
    return variables
  }
  ...
  render() {
    ...
    return (
      <div className="paginated-root" style={{backgroundColor: '#0000000a'}}>
        <Head
          ref="head"
